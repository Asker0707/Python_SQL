...
def add_client(conn, first_name, last_name, email, phones=None):
    ...
    with conn.cursor() as cur:
        ...
        for x in id:
            ...
            if x[0] is None and phones != None:
...
#search_client(connect_db,phone='+79688872539')
# add_client(connect_db,'Tom','Hanks','ToHa@dc.com')
...
# delete_client(connect_db, 3)
# search_client(connect_db,phone='+79282134121')
# change_client(connect_db,client_id='2',new_phone='+79254787577', old_phone='+79282134121')
